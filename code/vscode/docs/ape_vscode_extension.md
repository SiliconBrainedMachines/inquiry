...
>
> Treat this file as a design archive, not as the authoritative description of current extension behavior. Internal examples here that mention broader command inventories, `ape` vocabulary, or `docs/issues/*/plan.md` paths are historical design assumptions, not current implementation guidance. For the current public entry surface, see [../README.md](../README.md). For the canonical repository doctrine, see [../../docs/architecture.md](../../docs/architecture.md), [../../docs/roadmap.md](../../docs/roadmap.md), and [../../docs/spec/finite-ape-machine.md](../../docs/spec/finite-ape-machine.md).
