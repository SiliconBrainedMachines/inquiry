...
> **Type:** plan
> **Status:** draft
> **Depends on:** [first-paper-shell.md](first-paper-shell.md), [submission-target-and-formatting-decision.md](submission-target-and-formatting-decision.md), [short-paper-surrogate-template.md](short-paper-surrogate-template.md), [real-cfp-target-decision.md](real-cfp-target-decision.md), [abstract-draft.md](abstract-draft.md), [introduction-section-draft.md](introduction-section-draft.md), [method-section-draft.md](method-section-draft.md), [results-section-draft.md](results-section-draft.md), [limitations-and-threats-to-validity.md](limitations-and-threats-to-validity.md), [discussion-section-draft.md](discussion-section-draft.md)
> **Used by:** [first-paper-checklist.md](first-paper-checklist.md), [agenticdev-2026-ieee-manuscript-draft.md](agenticdev-2026-ieee-manuscript-draft.md), future manuscript draft

This document assembles the current paper-facing drafts into one short-paper manuscript
surface. It is intentionally closer to a venue-shaped draft than to a planning outline,
while remaining controlled by the atomic source documents in this folder and by
[submission-target-and-formatting-decision.md](submission-target-and-formatting-decision.md).
It now serves as the working AgenticDev 2026 manuscript surface and is kept compatible
with the provisional IEEE conference format recorded in
[real-cfp-target-decision.md](real-cfp-target-decision.md): one title block, one
abstract, one keyword line, one controlling cross-task table, and no appendix-dependent
argument.
