...
- PASS: overhead summary event counts transition=10, sensor_run=28, block=2, retry=1, phase_timing=7, tool_activity=5, model_activity=16 at cleanrooms/231-windows-ape-prompt-tests-should-use-git-resolved-p/run_trace.yaml:1
...
- PASS: overhead summary shows highest observed phase cost at EXECUTE=933.748s in cleanrooms/231-windows-ape-prompt-tests-should-use-git-resolved-p/run_trace.yaml:1
